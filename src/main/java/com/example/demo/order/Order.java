...
public class Order {
    ...
    void processOrder() {
        ...
        System.out.printf("You have chosen " + payment.getClass().getSimpleName() + " payment strategy");
        System.out.printf("You choose " + delivery.getClass().getSimpleName() + " delivery strategy");
